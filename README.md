...
## Project Structure
    ...
    ├── scheduling_a_seasom_31927  # Django project configurations
...
1. Clone this repo and `cd scheduling_a_seasom_31927`
...
2. Clone this repo and `cd scheduling_a_seasom_31927`
